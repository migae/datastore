...
link:doc/Entities.md[Entities], link:doc/Keychains.md[Keychains] and
link:doc/Datastore.md[Datastore].  Lots of simple
...
* `migae.datastore.PersistentEntityMap` - migae representation of underlying `com.google.appengine.api.datastore.Entity`.  Implements IPersistentCollection, IPersistentMap, IMapEntry, etc.  See link:doc/Entities.md[Entities].
* `migae.datastore.Keychain`  - migae representation of underlying `com.google.appengine.api.datastore.Key`.  A vector of Clojure keywords.  See link:doc/Keychains.md[Keychains].  (**Not yet implemented**)
...
link:doc/Keychains.md[Keychains] for more detail.
